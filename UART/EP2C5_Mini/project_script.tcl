...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "17:27:48  DEZEMBER 08, 2019"
	...
	set_location_assignment PIN_40 -to Led[3]
	...
	set_location_assignment PIN_45 -to btn[0]
	...
	set_location_assignment PIN_53 -to Rx
	set_location_assignment PIN_55 -to Tx
	set_location_assignment PIN_57 -to sw[0]
	set_location_assignment PIN_58 -to sw[1]
	set_location_assignment PIN_59 -to sw[2]
	set_location_assignment PIN_60 -to sw[3]
	set_location_assignment PIN_63 -to sw[4]
	set_location_assignment PIN_64 -to sw[5]
